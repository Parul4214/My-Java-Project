...
public class CruiseBookingMain {
	...
	public static void main(String[] args) {
		...
		if (change_info.equalsIgnoreCase("Y")) {
			...
			int new_info = sc.nextInt();
			if ((new_info == 1 || new_info == 2 || new_info == 3) && (user_info.password_check() == 1)) {
				switch (new_info) {
				case 1:
			...
			System.out.println("Personal information has not been changed");
